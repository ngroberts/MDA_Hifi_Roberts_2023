...
samtools view -q 30 > aln_artificial_reads_reliable_mapped.sam
...
python3 /grps2/kmk/Nick/2024-02-27_MDA_Seqkit_Samtools/scripts/get_mismatch.py > $ASSEMBLY"_mismatch_reads.txt"

cut -f 4 -d ' ' $ASSEMBLY"_mismatch_reads.txt" > reads_removed.txt
